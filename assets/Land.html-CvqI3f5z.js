import{_ as o}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as c,c as p,a as s,b as n,d as t,w as e,e as l}from"./app-C9ePvONR.js";const u={},d=s("h1",{id:"🛖圈地系统使用说明",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#🛖圈地系统使用说明","aria-hidden":"true"},"#"),n(" 🛖圈地系统使用说明")],-1),r={class:"hint-container info"},m=s("p",{class:"hint-container-title"},"提示",-1),k=l(`<h2 id="圈地系统特性" tabindex="-1"><a class="header-anchor" href="#圈地系统特性" aria-hidden="true">#</a> 圈地系统特性</h2><ul><li>支持多种圈地模式（2D/3D圈地）</li><li>圈地全程可视化操作</li><li>圈地系统独有交易市场</li><li>可自由配置领地内权限</li><li>管理员便捷管理领地</li></ul><h2 id="配置文件" tabindex="-1"><a class="header-anchor" href="#配置文件" aria-hidden="true">#</a> 配置文件</h2><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
